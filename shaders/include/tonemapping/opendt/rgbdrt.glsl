...
vec3 rgbdrtransform(vec3 rgb) {
    ...
    if (invert == 0) {
        ...
        // Tonescale
        rgb.x = rgb.x < 0.18f ? cs * pow(rgb.x, c0)
                              : c0 * (rgb.x - 0.18f) + 0.18f;
        rgb.y = rgb.y < 0.18f ? cs * pow(rgb.y, c0)
                              : c0 * (rgb.y - 0.18f) + 0.18f;
        rgb.z = rgb.z < 0.18f ? cs * pow(rgb.z, c0)
                              : c0 * (rgb.z - 0.18f) + 0.18f;
        ...
        rgb.x = rgb.x < 0.18f ? pow(rgb.x / cs, 1.0f / c0)
                              : (rgb.x - 0.18f) / c0 + 0.18f;
        rgb.y = rgb.y < 0.18f ? pow(rgb.y / cs, 1.0f / c0)
                              : (rgb.y - 0.18f) / c0 + 0.18f;
        rgb.z = rgb.z < 0.18f ? pow(rgb.z / cs, 1.0f / c0)
                              : (rgb.z - 0.18f) / c0 + 0.18f;
