...
const int colortex10Format = RGBA16F;        // clouds res  | low-res clouds apparent distance, indirect scattering, lightning intensity
const int colortex11Format = RGBA16F;        // full res    | clouds history (always)
const int colortex12Format = RGBA16F;        // full res    | clouds pixel age, apparent distance, indirect scattering, lightning intensity
