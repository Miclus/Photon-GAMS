...
CloudsParameters get_clouds_parameters(Weather weather) {
    ...
    // Towering Cumulus
    params.towering_cumulus_altitude_scale
        = 0.8 / clouds_towering_cumulus_thickness;
    params.towering_cumulus_detail_weights
    ...
    params.thunderhead_detail_weights
        = vec2(0.33, 0.40) * CLOUDS_THUNDERHEAD_DETAIL_STRENGTH;
