...
void water_waves_setup(
    ...
    // Adjustable water wave angle in GAMS-dev
...
float get_water_height(vec2 coord, vec2 wave_dir, mat2 wave_rot, float t) {
    ...
    // Noise 
    // Ajdustable water noise in GAMS-dev
    ...
    // Reciprocal of sum of amplitudes of all waves 
    ...
    for (uint i = 0u; i < WATER_WAVE_ITERATIONS; ++i) {
        ...
        noise_coord *= 2.5; // This matches the frequency increase logic for noise in both versions
    }
